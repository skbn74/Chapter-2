...
string tripOpening = compOpening.Remove(opening.IndexOf(searchTerm), searchTerm.Length);

if (compOpening.IndexOf(compSearchTerm, 0) != -1)
{
    Console.WriteLine("true"); 
    Console.WriteLine(compOpening.IndexOf(compSearchTerm));
    Console.WriteLine(compSearchTerm.Length);
    Console.WriteLine(compOpening.Remove(opening.IndexOf(searchTerm), searchTerm.Length));
...
//Console.WriteLine(compOpening.Remove(opening.IndexOf(searchTerm), searchTerm.Length));//
//Console.WriteLine(compOpening.Remove(opening.IndexOf(searchTerm), opening.IndgexOf(searchTerm))); 
